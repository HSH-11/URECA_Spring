...
<body>
	<div style="text-align: center;">
		...
		<form>
			...
			<input type="text" name="name" id="name"></input><br> <input
				type="text" name="email" id="email"></input><br> <input
				type="text" name="phone" id="phone"></input><br> <input
				type="text" name="address" id="address"></input><br>
		</form>
